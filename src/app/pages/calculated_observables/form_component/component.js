...
.directive('calculatedObservableForm', function() {
  return {
    templateUrl: 'app/pages/calculated_observables/form_component/form.html',
    restrict: 'E',
    replace: true,
    scope: {
      'model': '='
    },
    controller: function($scope, Calculated_observables, Bioportal, Measurement_types,Auth,toastr,CONFIG) {
      ...
      $scope.saveModel=function(){
        Calculated_observables.save($scope.model,$scope.observable).then(function(res){
          //success
