angular.module('CarreEntrySystem').filter('translateMapping', function(CarreTranslate) {
  ...
  var translations={
    ...
    "el": {
        ...
        "has_author":"Προσθέθηκε από",
        "has_reviewer":"Αξιολογήθηκε από",
        
        //medical_expert
        
        "has_firstname":"Ονομα",
        "has_lastname":"Επώνυμο",
        "has_medical_specialty":"Ιατρική Ειδικότητα",
        "has_medical_position":"Ιατρική θέση",
        "has_short_cv":"Σύντομο βιογραφικό",
        "has_personal_page_url":"Προσωπική Ιστοσελίδα",
        "has_user_graph":"Προσωπικός γράφος",
        
        //observable
        
        "has_observable_name":"Όνομα",
        "has_observable_acronym":"Ακρωνύμιο",
        "has_observable_type":"Τύπος",
        "has_external_type":"External Vocabulary",
        "has_external_predicate":"Sensors",
        "has_observable_measurement_type":"Measurement type",
        
        'observable_type_personal':'προσωπικό',
        'observable_type_clinical':'κλινικό',
        'observable_type_other':'άλλο',
        
        //risk element
        
        "has_risk_element_name":"Όνομα",
        "has_risk_element_identifier":"UMLS Identifier",
        "has_risk_element_type":"Τύπος",
        "has_risk_element_modifiable_status":"Modifiable status",
        "has_risk_element_observable":"Observable",
        "has_risk_element_observable_condition":"Observable condition",
        "includes_risk_element":"Περιέχει",
        ...
        "has_risk_factor_source":"Πηγή",
        "has_risk_factor_target":"Στόχος",
        "has_risk_factor_association_type":"Association type",
        'risk_factor_association_type_is_an_issue_in':'is an issue in',
        'risk_factor_association_type_causes':'causes',
        'risk_factor_association_type_reduces':'reduces',
