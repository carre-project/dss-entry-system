angular.module('CarreEntrySystem').service('content', function() {
  ...
  function getModelFields(fieldsArray, filterOutArray) {
    var columnDefs = [];
    filterOutArray = (filterOutArray || []).concat(['type','has_risk_element_identifier_system','has_risk_evidence_source','has_risk_evidence_observable','has_author','has_reviewer']);
